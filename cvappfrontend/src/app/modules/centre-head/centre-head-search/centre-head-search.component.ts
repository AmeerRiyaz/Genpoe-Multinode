...
@Component({
  selector: 'app-centre-head-search',
  templateUrl: './centre-head-search.component.html',
  styleUrls: ['./centre-head-search.component.css']
})
export class CentreHeadSearchComponent implements OnInit, OnDestroy {
  //form variables
