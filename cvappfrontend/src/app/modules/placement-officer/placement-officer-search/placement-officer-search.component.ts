...
@Component({
  selector: 'app-placement-officer-search',
  templateUrl: './placement-officer-search.component.html',
  styleUrls: ['./placement-officer-search.component.css']
})
export class PlacementOfficerSearchComponent implements OnInit, OnDestroy {
  //form variables
