module.exports = (app) => {
    ...
    app.post('/org/signout', poeusers.signout);
    ...
    app.get('/users/registered',poeusers.totalUsers);
    app.get('/users/students',poeusers.totalStudents);
    app.get('/users/enabledusers',poeusers.totalregisteredUsers);
