...
var upgradeChaincode = async function (peers, channelName, chaincodeName, chaincodeVersion, chaincodeType, functionName, args, username, org_name) {
	...
	//	console.log('Successfully got the fabric client for the organization "%s"', org_name);
		...
		let results = await channel.sendUpgradeProposal(request, 100000); //instantiate takes much longer
