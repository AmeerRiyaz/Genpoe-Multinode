...
export CC_SRC_PATH1="/home/mrwhite/work/Latest_march_2020/latest_code/pmchaincode/poe/node"

export CHANNEL_NAME1="generalpoechannel"
export CHANNEL_PATH1="../hyperledger/artifacts/channel/generalpoechannel/generalpoechannel.tx"
export CHANNEL_CODE_NAME1="cdacpoe"
export CHANNEL_VERSION1="v0"

export USER_NAME1="ravikishore1"
export USER_NAME2="saigopal1"
export USER_NAME3="sireesha1"
